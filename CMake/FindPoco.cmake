# ANDREW - Taken from https://raw.githubusercontent.com/ros2/poco_vendor/master/cmake/Modules/FindPoco.cmake
# Also ROS2! Who knew...
#
...
set(SUFFIX_FOR_LIBRARY_PATH
  ...
  poco-1.9.0/lib
  poco-1.9.0/lib/Linux/i686
  poco-1.9.0/lib/Linux/x86_64
  lib
  lib/Linux/i686
  lib/Linux/x86_64
)
    ...
    if(Poco_FOUNDATION_LIB)
      ...
      foreach(COMPONENT ${Poco_FIND_COMPONENTS})
        ...
        if(LIB${COMPONENT})
          ...
          message(STATUS "  Poco found, but missing component 'Poco${COMPONENT}${DBG}'...")
          message(STATUS "  This can happen when poco is found in release, but debug is required.")
          message(STATUS "  It could also be that debug is found, but release is required.")
